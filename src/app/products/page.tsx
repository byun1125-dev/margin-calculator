    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        ...
        <button
          ...
          className="flex items-center justify-center gap-1.5 px-4 py-2.5 bg-gray-900 text-white text-sm font-medium hover:bg-gray-800 transition-colors w-full sm:w-auto"
        >
          <Plus size={16} />
          현재 설정 저장
        </button>
